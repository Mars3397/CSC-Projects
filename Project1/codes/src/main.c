...
{
    // declare and init dev, net, esp, txp
    Dev dev;
    Net net;
    Esp esp;
    Txp txp;
    ...
    // str will later be used as buffer to get stdin 
    char *str = (char*)malloc(sizeof(char)*1024);

    // define fd and timeout value
    fd_set readfds;
    ...
    /*
     state is used to decide which action that we are going to take
    ...
    *test_for_dissect = true;
    ...
    // record victim ip and server ip
    bool first = true;
